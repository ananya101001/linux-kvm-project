...
$(deps_fs/posix_acl.o):
#SYMVER get_cached_acl 0xb30de39e
#SYMVER get_cached_acl_rcu 0xfdefd50f
#SYMVER set_cached_acl 0x51c1f653
#SYMVER forget_cached_acl 0x7a160841
#SYMVER forget_all_cached_acls 0x25b50825
#SYMVER get_inode_acl 0x0fb0c781
#SYMVER posix_acl_init 0xc7f28969
#SYMVER posix_acl_alloc 0x95bfe643
#SYMVER posix_acl_clone 0x60e80efb
#SYMVER posix_acl_valid 0x05adaa45
#SYMVER posix_acl_equiv_mode 0xa622b393
#SYMVER posix_acl_from_mode 0xe0dae0b0
#SYMVER __posix_acl_create 0x0ea57eeb
#SYMVER __posix_acl_chmod 0x7968252f
#SYMVER posix_acl_chmod 0x98ebe455
#SYMVER posix_acl_create 0xfa4854d6
#SYMVER posix_acl_update_mode 0x570b6af3
#SYMVER posix_acl_from_xattr 0x33006886
#SYMVER posix_acl_to_xattr 0x3b1d7649
#SYMVER set_posix_acl 0xa61639bd
#SYMVER nop_posix_acl_access 0x78d37bb3
#SYMVER nop_posix_acl_default 0xd9c7d1e4
#SYMVER vfs_set_acl 0x86a1715e
#SYMVER vfs_get_acl 0x2572479c
#SYMVER vfs_remove_acl 0x71cf7980
