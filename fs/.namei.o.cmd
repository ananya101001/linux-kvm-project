...
#SYMVER generic_permission 0x37bfdd7f
#SYMVER inode_permission 0xc3803b8a
#SYMVER path_get 0x411c18ff
#SYMVER path_put 0xd9a86cd3
#SYMVER follow_up 0x0db07d9c
#SYMVER follow_down_one 0xf430a79a
#SYMVER follow_down 0x869672d1
#SYMVER lookup_one_qstr_excl 0x93749243
#SYMVER full_name_hash 0xd6eaaea1
#SYMVER hashlen_string 0x162893fd
#SYMVER user_path_locked_at 0xe5c5caee
#SYMVER kern_path 0x28d809fe
#SYMVER vfs_path_parent_lookup 0xa5156177
#SYMVER vfs_path_lookup 0x0be4b902
#SYMVER try_lookup_one_len 0xb6a188bf
#SYMVER lookup_one_len 0x7e9be7cc
#SYMVER lookup_one 0x6216a7d1
#SYMVER lookup_one_unlocked 0xdc32eede
#SYMVER lookup_one_positive_unlocked 0x3adbb435
#SYMVER lookup_one_len_unlocked 0x0309b511
#SYMVER lookup_positive_unlocked 0x9554e7e3
#SYMVER user_path_at 0xa0a8c3ef
#SYMVER __check_sticky 0xc244cbee
#SYMVER lock_rename 0xab785dcd
#SYMVER lock_rename_child 0x3d017404
#SYMVER unlock_rename 0xa55a3b1c
#SYMVER vfs_create 0xe33c66e4
#SYMVER vfs_mkobj 0x7f892030
#SYMVER kernel_tmpfile_open 0x401e7bdc
#SYMVER kern_path_create 0x8f6a8145
#SYMVER done_path_create 0xa36116d9
#SYMVER user_path_create 0x43a1c776
#SYMVER vfs_mknod 0x7d68dc6e
#SYMVER vfs_mkdir 0xe09105d6
#SYMVER vfs_rmdir 0x3820e3a2
#SYMVER vfs_unlink 0xbd895631
#SYMVER vfs_symlink 0x6f46783b
#SYMVER vfs_link 0x2d3a4d18
#SYMVER vfs_rename 0x79b8173a
#SYMVER vfs_readlink 0x04c2c331
#SYMVER vfs_get_link 0xb7e5f43b
#SYMVER page_get_link 0x3c962011
#SYMVER page_put_link 0x3c185c61
#SYMVER page_readlink 0xb258bd8d
#SYMVER page_symlink 0xb62c3fae
#SYMVER page_symlink_inode_operations 0xcddfe950
