...
$(deps_mm/filemap.o):
#SYMVER filemap_check_errors 0x660a4995
#SYMVER filemap_fdatawrite_wbc 0x3a90a933
#SYMVER filemap_fdatawrite 0x136bf523
#SYMVER filemap_fdatawrite_range 0x13be1388
#SYMVER filemap_flush 0x798cf323
#SYMVER filemap_range_has_page 0xdfd5dfb0
#SYMVER filemap_fdatawait_range 0xcf2787c1
#SYMVER filemap_fdatawait_range_keep_errors 0xacdfaf1e
#SYMVER file_fdatawait_range 0xcc479662
#SYMVER filemap_fdatawait_keep_errors 0xb326b051
#SYMVER filemap_range_has_writeback 0x6ed0eeed
#SYMVER filemap_write_and_wait_range 0x091315a8
#SYMVER __filemap_set_wb_err 0xc80e584f
#SYMVER file_check_and_advance_wb_err 0xb38f14bd
#SYMVER file_write_and_wait_range 0xbd865a52
#SYMVER replace_page_cache_folio 0x0bdb46cb
#SYMVER filemap_add_folio 0x3f8dafcc
#SYMVER filemap_alloc_folio_noprof 0x90fb2be8
#SYMVER filemap_invalidate_lock_two 0x754205ff
#SYMVER filemap_invalidate_unlock_two 0x5e047b55
#SYMVER folio_wait_bit 0x59ae6a7d
#SYMVER folio_wait_bit_killable 0xb896ef53
#SYMVER folio_add_wait_queue 0x0058b83d
#SYMVER folio_unlock 0xbc109bda
#SYMVER folio_end_read 0x236b5858
#SYMVER folio_end_private_2 0x92962a2c
#SYMVER folio_wait_private_2 0x54b272a1
#SYMVER folio_wait_private_2_killable 0xd45b36ea
#SYMVER folio_end_writeback 0xd1405ef8
#SYMVER __folio_lock 0x755f876b
#SYMVER __folio_lock_killable 0xf67e9295
#SYMVER page_cache_next_miss 0x8d3c30d7
#SYMVER page_cache_prev_miss 0x0b672336
#SYMVER __filemap_get_folio 0x4ab26199
#SYMVER filemap_get_folios 0x2d8dd19b
#SYMVER filemap_get_folios_contig 0xc2c680b6
#SYMVER filemap_get_folios_tag 0xe98bb472
#SYMVER filemap_read 0xea3c6898
#SYMVER kiocb_write_and_wait 0xe9a3db62
#SYMVER kiocb_invalidate_pages 0x24772ede
#SYMVER generic_file_read_iter 0xf103436a
#SYMVER filemap_splice_read 0x13e1d65f
#SYMVER filemap_fault 0x3d891110
#SYMVER filemap_map_pages 0x4d6af5c8
#SYMVER filemap_page_mkwrite 0xa42c2029
#SYMVER generic_file_mmap 0xd747ff84
#SYMVER generic_file_readonly_mmap 0x89e3fec0
#SYMVER read_cache_folio 0xbb53a751
#SYMVER mapping_read_folio_gfp 0xa896e811
#SYMVER read_cache_page 0xbe5aef23
#SYMVER read_cache_page_gfp 0x23b7ae50
#SYMVER generic_file_direct_write 0x27f8df17
#SYMVER generic_perform_write 0x02b8af2d
#SYMVER __generic_file_write_iter 0x719dc8e3
#SYMVER generic_file_write_iter 0x21aa85d0
#SYMVER filemap_release_folio 0xdabcd9b0
#SYMVER filemap_invalidate_inode 0xaf4526b9
