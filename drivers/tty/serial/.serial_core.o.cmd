...
$(deps_drivers/tty/serial/serial_core.o):
#SYMVER uart_write_wakeup 0xb0840a20
#SYMVER uart_update_timeout 0x51d6f4cc
#SYMVER uart_get_baud_rate 0xa131ca0f
#SYMVER uart_get_divisor 0xd2ce4c52
#SYMVER uart_xchar_out 0x13f567a7
#SYMVER uart_console_write 0x292b2eac
#SYMVER uart_parse_earlycon 0xc5a5c678
#SYMVER uart_parse_options 0x4f72a987
#SYMVER uart_set_options 0xb025e04c
#SYMVER uart_suspend_port 0xa789a976
#SYMVER uart_resume_port 0x90a46d3a
#SYMVER uart_register_driver 0x387ec40b
#SYMVER uart_unregister_driver 0xe306fa60
#SYMVER uart_console_device 0xabe2f312
#SYMVER uart_match_port 0x44b11005
#SYMVER uart_handle_dcd_change 0x6ee5293f
#SYMVER uart_handle_cts_change 0xc853e6ed
#SYMVER uart_insert_char 0x2cf490d3
#SYMVER uart_try_toggle_sysrq 0x28b8ede0
#SYMVER uart_get_rs485_mode 0x9bf8713f
