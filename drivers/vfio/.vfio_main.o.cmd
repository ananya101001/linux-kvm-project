...
deps_drivers/vfio/vfio_main.o := \
  ...
  drivers/vfio/vfio.h \
    ...
    $(wildcard include/config/VFIO_DEBUGFS) \

drivers/vfio/vfio_main.o: $(deps_drivers/vfio/vfio_main.o)

$(deps_drivers/vfio/vfio_main.o):
#SYMVER vfio_assign_device_set 0x2af6b088
#SYMVER vfio_device_set_open_count 0x48ee7465
#SYMVER vfio_find_device_in_devset 0x56160fed
#SYMVER _vfio_alloc_device 0x87b79fa4
#SYMVER vfio_register_group_dev 0x3004042e
#SYMVER vfio_register_emulated_iommu_dev 0xf29b4af4
#SYMVER vfio_unregister_group_dev 0x353484e6
#SYMVER vfio_mig_get_next_state 0x839d585f
#SYMVER vfio_combine_iova_ranges 0x6e2aa0f0
#SYMVER vfio_file_is_valid 0x5dc3f266
#SYMVER vfio_file_enforced_coherent 0x0eb9fb21
#SYMVER vfio_file_set_kvm 0x50dcf458
#SYMVER vfio_info_cap_add 0x60a634c4
#SYMVER vfio_info_cap_shift 0x19567d06
#SYMVER vfio_info_add_capability 0x6c28be5a
#SYMVER vfio_set_irqs_validate_and_prepare 0xadc044b7
#SYMVER vfio_pin_pages 0xe0149b60
#SYMVER vfio_unpin_pages 0xa6a5f576
#SYMVER vfio_dma_rw 0x8ad8f450
