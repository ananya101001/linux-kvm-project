...
$(deps_drivers/base/core.o):
#SYMVER fw_devlink_purge_absent_suppliers 0x1d87c2cc
#SYMVER device_link_wait_removal 0x29a1491b
#SYMVER device_link_add 0xd0646dbf
#SYMVER device_link_del 0x71c2cf22
#SYMVER device_link_remove 0xe20d1413
#SYMVER dev_driver_string 0xee99c7ef
#SYMVER device_store_ulong 0x84431c72
#SYMVER device_show_ulong 0xb510e22a
#SYMVER device_store_int 0x4cd92c69
#SYMVER device_show_int 0xa79fda42
#SYMVER device_store_bool 0x744cb35c
#SYMVER device_show_bool 0x121ee74c
#SYMVER device_show_string 0x1137bc47
#SYMVER device_add_groups 0xbe78cdeb
#SYMVER device_remove_groups 0x22b1bdee
#SYMVER devm_device_add_group 0xabed9abe
#SYMVER device_create_file 0x97187c10
#SYMVER device_remove_file 0xeeea671c
#SYMVER device_remove_file_self 0x54ab7283
#SYMVER device_create_bin_file 0x26cc38f9
#SYMVER device_remove_bin_file 0xf3fd5fb8
#SYMVER device_initialize 0xe7fa695f
#SYMVER dev_set_name 0xc6f15b39
#SYMVER device_add 0x934ea33f
#SYMVER device_register 0x3d4155c2
#SYMVER get_device 0x3131271a
#SYMVER put_device 0xca844bc7
#SYMVER kill_device 0x87234cc2
#SYMVER device_del 0xc04e9955
#SYMVER device_unregister 0xdedf4785
#SYMVER device_for_each_child 0x80b29ea5
#SYMVER device_for_each_child_reverse 0x9e918d06
#SYMVER device_for_each_child_reverse_from 0x139faf07
#SYMVER device_find_child 0x02037cee
#SYMVER device_find_child_by_name 0xdec64f2b
#SYMVER device_find_any_child 0xc6d51bb4
#SYMVER __root_device_register 0xf95fd438
#SYMVER root_device_unregister 0x5503b9a4
#SYMVER device_create 0x5d480ef3
#SYMVER device_create_with_groups 0xdc4290c3
#SYMVER device_destroy 0x50785e75
#SYMVER device_rename 0x6c2b6301
#SYMVER device_move 0x5b5b760d
#SYMVER device_change_owner 0xc468e26c
#SYMVER dev_vprintk_emit 0xc632be00
#SYMVER dev_printk_emit 0x0cbc8f40
#SYMVER _dev_printk 0xe3a61ac6
#SYMVER _dev_emerg 0x31b142f7
#SYMVER _dev_alert 0x601eb63b
#SYMVER _dev_crit 0x3d9c6c54
#SYMVER _dev_err 0x1fa6d5d3
#SYMVER _dev_warn 0x3cf0e521
#SYMVER _dev_notice 0xe726acf2
#SYMVER _dev_info 0x05a549f7
#SYMVER dev_err_probe 0x68795753
#SYMVER set_primary_fwnode 0x4ea4e308
#SYMVER set_secondary_fwnode 0xb0b0139b
#SYMVER device_set_of_node_from_dev 0x8f257f9b
#SYMVER device_set_node 0x652b96e1
#SYMVER device_match_name 0x7c07cb36
#SYMVER device_match_of_node 0x8592c9d8
#SYMVER device_match_fwnode 0xb5a8d881
#SYMVER device_match_devt 0x8c30cfd1
#SYMVER device_match_acpi_dev 0x431d8bbd
#SYMVER device_match_acpi_handle 0x68898c90
#SYMVER device_match_any 0x1f38f5dd
