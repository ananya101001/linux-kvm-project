...
$(deps_net/core/sock.o):
#SYMVER sk_ns_capable 0xb37757c2
#SYMVER sk_capable 0xf5257721
#SYMVER sk_net_capable 0x1b084daa
#SYMVER sysctl_wmem_max 0xfac8865f
#SYMVER sysctl_rmem_max 0xb05fc310
#SYMVER memalloc_socks_key 0x77ecf68d
#SYMVER sk_set_memalloc 0xfa3989a8
#SYMVER sk_clear_memalloc 0x2b6f5f21
#SYMVER __sk_backlog_rcv 0xf0e8b035
#SYMVER sk_error_report 0x80792a17
#SYMVER sock_get_timeout 0xedd17b31
#SYMVER sock_copy_user_timeval 0x5bdb7603
#SYMVER __sock_queue_rcv_skb 0xb5a3d65a
#SYMVER sock_queue_rcv_skb_reason 0x84849b0a
#SYMVER __sk_receive_skb 0xc07bea73
#SYMVER __sk_dst_check 0x8b8c75df
#SYMVER sk_dst_check 0xd8ae89f8
#SYMVER sock_bindtoindex 0x10bd2afd
#SYMVER sk_mc_loop 0xc6d39825
#SYMVER sock_set_reuseaddr 0x12ba8633
#SYMVER sock_set_reuseport 0xc693b455
#SYMVER sock_no_linger 0xeb515a8f
#SYMVER sock_set_priority 0x271e1100
#SYMVER sock_set_sndtimeo 0xc0961778
#SYMVER sock_enable_timestamps 0xbb9e82cc
#SYMVER sock_set_keepalive 0x2f68abb4
#SYMVER sock_set_rcvbuf 0xfeb41ed7
#SYMVER sock_set_mark 0xc4ca980a
#SYMVER sockopt_lock_sock 0xef25f2f1
#SYMVER sockopt_release_sock 0x869ac3ca
#SYMVER sockopt_ns_capable 0x69d71f8b
#SYMVER sockopt_capable 0x2a6a5aac
#SYMVER sock_setsockopt 0xc8e2f441
#SYMVER sk_alloc 0x9e90bee3
#SYMVER sk_free 0x98a94a64
#SYMVER sk_clone_lock 0xc646c780
#SYMVER sk_free_unlock_clone 0x935d7664
#SYMVER sk_setup_caps 0x9146f128
#SYMVER sock_wfree 0xd6cc4b99
#SYMVER skb_set_owner_w 0x9b2319ad
#SYMVER skb_orphan_partial 0xeee6d7f3
#SYMVER sock_rfree 0xd2826095
#SYMVER sock_efree 0x76afd79e
#SYMVER sock_pfree 0xbdb48f78
#SYMVER sock_i_uid 0x42bf3d6e
#SYMVER __sock_i_ino 0xdf0e7b35
#SYMVER sock_i_ino 0x0c732619
#SYMVER sock_wmalloc 0x0942c595
#SYMVER sock_kmalloc 0x59681009
#SYMVER sock_kfree_s 0x9ca3c8f9
#SYMVER sock_kzfree_s 0x8482629f
#SYMVER sock_alloc_send_pskb 0xf1ece1d0
#SYMVER __sock_cmsg_send 0x9bd25d36
#SYMVER sock_cmsg_send 0x2b75c0a2
#SYMVER skb_page_frag_refill 0xa2c81948
#SYMVER sk_page_frag_refill 0x7606d9e0
#SYMVER __sk_flush_backlog 0xb1184d61
#SYMVER sk_wait_data 0xf74d893d
#SYMVER __sk_mem_schedule 0x5cba5c05
#SYMVER __sk_mem_reclaim 0xe267ef1c
#SYMVER sk_set_peek_off 0xe07cc1fc
#SYMVER sock_no_bind 0x4187ec08
#SYMVER sock_no_connect 0x4a64b48b
#SYMVER sock_no_socketpair 0xf6c2d54b
#SYMVER sock_no_accept 0x395738dd
#SYMVER sock_no_getname 0xaec33742
#SYMVER sock_no_ioctl 0xb9622331
#SYMVER sock_no_listen 0xfa6431fc
#SYMVER sock_no_shutdown 0x17574c5c
#SYMVER sock_no_sendmsg 0x3946661f
#SYMVER sock_no_sendmsg_locked 0xefe7ae2e
#SYMVER sock_no_recvmsg 0x2bc7f07d
#SYMVER sock_no_mmap 0xb8c586b9
#SYMVER sk_send_sigurg 0x0fbc8dcf
#SYMVER sk_reset_timer 0x7c87ef04
#SYMVER sk_stop_timer 0xccb4fee5
#SYMVER sk_stop_timer_sync 0x72ce84b9
#SYMVER sock_init_data_uid 0xb5823390
#SYMVER sock_init_data 0xf5cef368
#SYMVER lock_sock_nested 0x0dc145e5
#SYMVER release_sock 0xdb579ef1
#SYMVER __lock_sock_fast 0xf8a820a2
#SYMVER sock_gettstamp 0x2c7043de
#SYMVER sock_recv_errqueue 0x54fe64c5
#SYMVER sock_common_getsockopt 0xd3e5d506
#SYMVER sock_common_recvmsg 0xc3baad71
#SYMVER sock_common_setsockopt 0xb9d57ab0
#SYMVER sk_common_release 0xd529175d
#SYMVER sock_prot_inuse_get 0x76f19eb5
#SYMVER sock_inuse_get 0x26761c9e
#SYMVER proto_register 0xd327bfd0
#SYMVER proto_unregister 0x18c05d36
#SYMVER sock_load_diag_module 0xf665f74f
#SYMVER sk_busy_loop_end 0xe590dea3
#SYMVER sock_bind_add 0x52e19b0c
#SYMVER sock_ioctl_inout 0xb557e327
#SYMVER sk_ioctl 0x4ab005e5
