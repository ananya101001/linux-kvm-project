...
$(deps_net/socket.o):
#SYMVER sock_alloc_file 0xac9cb618
#SYMVER sock_from_file 0x348b5b34
#SYMVER sockfd_lookup 0xe820e399
#SYMVER sock_alloc 0xdee708e7
#SYMVER sock_release 0x8d0e1b55
#SYMVER __sock_tx_timestamp 0x437a0d6d
#SYMVER sock_sendmsg 0x58d3c8ec
#SYMVER kernel_sendmsg 0x5d78eaca
#SYMVER kernel_sendmsg_locked 0x09d925b0
#SYMVER __sock_recv_timestamp 0x2cb9f673
#SYMVER __sock_recv_cmsgs 0x7ad2d6c8
#SYMVER sock_recvmsg 0x7007a625
#SYMVER kernel_recvmsg 0x07995fd1
#SYMVER brioctl_set 0x81850611
#SYMVER vlan_ioctl_set 0x2e4cb791
#SYMVER sock_create_lite 0xa976b456
#SYMVER sock_wake_async 0x907d61c4
#SYMVER __sock_create 0xe554bb91
#SYMVER sock_create 0xef1cc86c
#SYMVER sock_create_kern 0x3674db8e
#SYMVER do_sock_setsockopt 0xa7bf68e4
#SYMVER do_sock_getsockopt 0x192fde8a
#SYMVER sock_register 0xddd9a9d2
#SYMVER sock_unregister 0x62737e1d
#SYMVER get_user_ifreq 0x80816f26
#SYMVER put_user_ifreq 0x87809aeb
#SYMVER kernel_bind 0xedc25195
#SYMVER kernel_listen 0x9f30d669
#SYMVER kernel_accept 0xa90b9bf5
#SYMVER kernel_connect 0xb62635b2
#SYMVER kernel_getsockname 0xd9ab9937
#SYMVER kernel_getpeername 0x6fc4a20a
#SYMVER kernel_sock_shutdown 0x5f445884
#SYMVER kernel_sock_ip_overhead 0x7f597b83
