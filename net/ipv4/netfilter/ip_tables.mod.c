...
SYMBOL_CRC(ipt_alloc_initial_table, 0x75981072, "_gpl");
SYMBOL_CRC(ipt_register_table, 0x78112188, "");
SYMBOL_CRC(ipt_unregister_table_pre_exit, 0x056e357c, "");
SYMBOL_CRC(ipt_unregister_table_exit, 0xfa449a37, "");
SYMBOL_CRC(ipt_do_table, 0xc0446c7d, "");
