...
SYMBOL_CRC(ip6t_alloc_initial_table, 0x4053ffcb, "_gpl");
SYMBOL_CRC(ip6t_register_table, 0x1209e74f, "");
SYMBOL_CRC(ip6t_unregister_table_pre_exit, 0x9fd51f8a, "");
SYMBOL_CRC(ip6t_unregister_table_exit, 0x93bd55a7, "");
SYMBOL_CRC(ip6t_do_table, 0x115e819e, "");
