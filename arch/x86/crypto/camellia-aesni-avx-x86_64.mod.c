...
KSYMTAB_FUNC(camellia_ecb_enc_16way, "_gpl", "");
KSYMTAB_FUNC(camellia_ecb_dec_16way, "_gpl", "");
KSYMTAB_FUNC(camellia_cbc_dec_16way, "_gpl", "");

SYMBOL_CRC(camellia_ecb_enc_16way, 0x2c8b5dbf, "_gpl");
SYMBOL_CRC(camellia_ecb_dec_16way, 0x8b44ee75, "_gpl");
SYMBOL_CRC(camellia_cbc_dec_16way, 0x339c33c5, "_gpl");
...
MODULE_INFO(depends, "crypto_simd,camellia-x86_64");
