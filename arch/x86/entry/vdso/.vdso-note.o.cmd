savedcmd_arch/x86/entry/vdso/vdso-note.o := gcc -Wp,-MMD,arch/x86/entry/vdso/.vdso-note.o.d -nostdinc -I./arch/x86/include -I./arch/x86/include/generated  -I./include -I./arch/x86/include/uapi -I./arch/x86/include/generated/uapi -I./include/uapi -I./include/generated/uapi -include ./include/linux/compiler-version.h -include ./include/linux/kconfig.h -D__KERNEL__ -fmacro-prefix-map=./= -D__ASSEMBLY__ -fno-PIE -m64 -DCC_USING_FENTRY -DBUILD_VDSO    -DKBUILD_MODFILE='"arch/x86/entry/vdso/vdso-note"' -DKBUILD_MODNAME='"vdso_note"' -D__KBUILD_MODNAME=kmod_vdso_note -c -o arch/x86/entry/vdso/vdso-note.o arch/x86/entry/vdso/vdso-note.S 
